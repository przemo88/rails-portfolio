class Page < ApplicationRecord
    ...
    length: {maximum: 250, message: "Opis nie może przekraczać 250 znaków."}
    ...
    format: {with: /http:\/\/[Aa-zZ]{1,}.przemyslawprzewoznik.pl\//, message: "To nie jest poprawny link do strony."}
